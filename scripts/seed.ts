...
const FUNDS: SeedFund[] = [
  ...
  },
  {
    ...
    sourceUrl: "https://www.enisa.es/financiacion/prestamos-participativos/jovenes-emprendedores",
    slug: "enisa-jovenes-emprendedores-prestamo-participativo-enisa-jovenes",
    title: "ENISA Jóvenes Emprendedores — Préstamo para emprendedores de 18 a 40 años",
    organism: "ENISA — Empresa Nacional de Innovación (Ministerio de Industria)",
    description:
      "Préstamos participativos exclusivos para emprendedores de entre 18 y 40 años con startups innovadoras. Sin garantías reales, carencia de hasta 7 años y tipos de interés reducidos.\n\n⚠️ Requisito de edad: el emprendedor principal debe tener entre 18 y 40 años en el momento de la solicitud.\n\n• Importe: 75.000 € – 300.000 €\n• Carencia: hasta 7 años\n• Empresa creada hace menos de 2 años o en proceso de constitución",
    shortDescription:
      "Solo para emprendedores de 18 a 40 años. Préstamo participativo sin garantías hasta 300.000 € con 7 años de carencia.",
    scope: "ESPAÑA",
    euFunded: false,
    euProgram: null,
    ...
    applicationUrl: "https://www.enisa.es/financiacion/prestamos-participativos/jovenes-emprendedores",
  ...
  },
  {
    ...
    sourceUrl: "https://www.oficinadeempresa.gencat.cat/es/tramits/autoempleo/",
    ...
    description:
      "Programa cofinanciado con FSE+ para personas desempleadas que se establecen como autónomas en Cataluña.\n\n⚠️ Requisito: debes estar en situación de desempleo e inscrito/a como demandante de empleo en el SOC en el momento de solicitar la ayuda.\n\n• Subvención base: hasta 10.000 €\n• Bonificaciones en cuota RETA\n• Formación complementaria subvencionada",
    shortDescription:
      "Solo para personas desempleadas inscritas en el SOC. Hasta 10.000 € al darse de alta como autónomo/a en Cataluña. Cofinanciada por FSE+.",
    scope: "CATALUÑA",
    region: "Cataluña",
    euFunded: true,
    euProgram: "FSE_PLUS",
    ...
    applicationUrl: "https://www.oficinadeempresa.gencat.cat/es/tramits/autoempleo/",
  ...
  },
  {
    ...
    sourceUrl: "https://www.enisa.es/financiacion/prestamos-participativos/emprendedoras",
    ...
    description:
      "Préstamos sin garantías para proyectos tecnológicos liderados por mujeres o con ≥50% de participación femenina en el equipo fundador.\n\n⚠️ Requisito de género: el equipo fundador debe tener mayoría femenina (≥50% del capital o del equipo fundador en manos de mujeres).\n\n• Importe: 25.000 € – 300.000 €\n• Carencia: hasta 5 años\n• Sin garantías reales",
    shortDescription:
      "Solo para startups con equipo fundador femenino mayoritario (≥50% mujeres). Préstamo sin garantías hasta 300.000 € con 5 años de carencia.",
    scope: "ESPAÑA",
    euFunded: false,
    euProgram: null,
    euProgramDetail: null,
    ...
    openDate: "2026-01-01",
    closeDate: "2026-11-30",
    applicationUrl: "https://www.enisa.es/financiacion/prestamos-participativos/emprendedoras",
